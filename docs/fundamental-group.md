...
- 위상동형 판별: 기본군이 다르면 위상동형이 아니다. 원과 구면, 원환면과 구면이 다름을 이렇게 확인한다. 반대는 성립하지 않는다. 2차원 구면과 3차원 구면은 둘 다 단일연결이지만 위상동형이 아니다.
