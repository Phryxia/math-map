...
물리와 미분방정식에서 실제로 다루는 작용소는 대개 [유계가 아니다](bounded-operators.md). 미분 $-i\thinspace d/dx$ 는 고주파 성분을 마음대로 키우므로 $L^2$ 전체에서 연속일 수 없고, 사실 $L^2$ 전체에서 정의되지도 않는다.
...
셋 다 조밀하고 셋 다 같은 미분 표현을 쓴다. 그런데 첫째는 자기수반이 아니고, 둘째는 각 $\theta$ 마다 자기수반이며 스펙트럼이 $\lbrace 2\pi n+\theta\rbrace$ 로 서로 다르고, 셋째는 대칭조차 아니다.
