...
$J_0(N)$ 의 Hecke 작용을 유한 계산으로 다루는 표준 도구는 **모듈러 기호**다. 첨점 두 개를 잇는 경로의 [호몰로지](homology.md)류를 형식적으로 다루어 $H_1(X_0(N),\mathbb Z)$ 의 기저와 그 위의 Hecke 행렬을 정수 선형대수로 계산하며, 새형식 표가 이 방법으로 만들어진다.
