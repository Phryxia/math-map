...
- [추상해석](abstract-interpretation.md) — 구체 의미론과 추상 영역을 Galois 연결로 잇고 과대근사의 건전성을 얻는다
...
- [선택공리](axiom-of-choice.md) — 사슬마다 상계가 있으면 극대원소가 있다는 형태로 순서를 쓴다
- [서수](ordinals.md) — 정렬순서, 곧 모든 비어 있지 않은 부분집합이 최소원소를 가지는 전순서
