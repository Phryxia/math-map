...
모형론은 1차 논리식이 구조에 대해 무엇을 말할 수 있는지 다룬다. 한 이론의 모형들이 서로 얼마나 다를 수 있는지, 논리식이 정의하는 부분집합이 어떤 모양인지가 물음이다.
...
- 대수적 폐체의 양화사 소거에서 Chevalley 정리와 Ax–Grothendieck 정리가 나온다. 뒤의 것은 복소 아핀 공간의 단사 다항식 사상이 전사라는 진술이고, 증명은 유한체 위에서 성립함을 보인 뒤 $\mathrm{ACF}\_0$ 로 옮기는 것이다.
...
- 안정성 이론이 정의 가능 집합의 조합적 성질로 이론을 분류한다. Hrushovski 는 이 언어로 함수체 위의 Mordell–Lang 추측을 증명했다.
