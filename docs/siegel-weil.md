...
// r_8(1..6) = 16, 112, 448, 1136, 2016, 3136
```
...
Kudla–Rallis 는 Eisenstein 급수를 $s$ 의 함수로 놓고 유수를 취해 Weil 조건을 크게 완화했다. 정칙화된 Siegel–Weil 공식은 theta 올림의 비소멸 판정과 [GGP](gan-gross-prasad.md) 계열 주기 문제의 표준 도구다. Kudla 는 좌변의 theta 적분을 Shimura 다양체 위 사이클의 생성함수로 바꾸는 **산술 Siegel–Weil 공식**을 제안했다.
...
- **격자 이론과 부호 이론.** 질량 공식은 주어진 판별식과 차원에서 격자의 규모를 미리 알려주므로 분류의 발판이 된다. Niemeier 의 24 개 분류와 자기쌍대 부호의 분류가 이 계산을 썼다.
