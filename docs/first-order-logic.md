...
이 일치가 Gödel의 건전성·완전성 정리이며, 그 부산물인 compactness 정리는 모델 이론 전체의 기본 도구가 된다. 군·환·체 같은 대수 구조와 [ZFC 공리계](zfc-axioms.md)(Zermelo–Fraenkel with choice)는 모두 1차 논리의 이론으로 표현되므로, 1차 논리는 현대 수학의 기본 서술 언어다.
