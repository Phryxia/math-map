...
"모든 사람은 죽는다"를 명제 논리로는 쪼갤 수 없다. 1차 논리는 대상 변수 x, 술어 Human, Mortal을 도입해 "모든 x에 대해 Human(x)이면 Mortal(x)"로 쓴다. 논의 영역(domain)의 원소를 변수로 지목하고, 술어로 원소의 성질과 관계를 말하는 언어다.
