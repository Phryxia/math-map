...
받침의 끝은 늘 조금씩 **아래로** 빗나간다. $\gamma = 0.25$ 에서 $2.233$ 대 예측 $2.25$ 이고, $\gamma = 0.5$ 에서 $2.720$ 대 $2.914$ 다. 무작위 요동이면 양쪽으로 갈릴 텐데 한 방향으로만 어긋난다. 위에서 말한 Tracy–Widom 편향이며, 최대 고윳값은 평균적으로 받침 끝보다 안쪽에 있다.
