...
$\mathbb Q$ 위 타원곡선의 비틀림 부분군으로 무엇이 가능한지는 1977 년 Mazur 의 정리 전까지 유한성조차 증명되지 않았다.
...
그러면 유리점 $x$ 가 주는 $x-\infty$ 의 상이 첨점군 안에 놓이고 그 위수가 작으므로 $x$ 가 첨점이거나 특별한 점임이 강제된다. 특별한 점들은 CM 곡선에 대응하고 손으로 검사할 수 있다.
...
이고 마지막 여섯은 CM 점에 대응한다. $163$ 이 여기 나타나는 것과 $e^{\pi\sqrt{163}}$ 이 거의 정수인 것은 같은 사실의 두 얼굴이다.
