...
- 자기 무모순성을 증명하는 체계가 아예 없다는 뜻도 아니다. 무모순이지만 약해서 가설을 만족하지 못하는 체계나, 애초에 모순인 체계는 자기 무모순성을 증명할 수 있다. 또 $T$ 의 무모순성은 더 강한 이론에서 증명될 수 있다. Gentzen은 $\varepsilon_0$ 까지의 초한귀납법으로 PA의 무모순성을 증명했다([서수와 초한귀납법](ordinals.md)).
