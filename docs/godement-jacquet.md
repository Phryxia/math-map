...
- **[Rankin–Selberg](rankin-selberg.md).** Jacquet–Piatetski-Shapiro–Shalika 의 적분이 $\mathrm{GL}\_n\times\mathrm{GL}\_m$ 의 $L$ 함수에서 같은 역할을 한다. 함수성 판정과 Ramanujan 형 추정의 주요 도구다.
