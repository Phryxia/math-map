...
두 정리는 부호의 존재만 주장한다. 실제 부호는 [오류정정부호](error-correcting-codes.md)가 [유한체](finite-fields.md) 위의 선형대수로 구성하고, 그 조합 구조가 [Mathieu 군](mathieu-groups.md), [구 채우기](sphere-packing.md)로 이어진다.
...
- [Mathieu 군](mathieu-groups.md) — 이진 Golay 부호의 자기동형군이 산재 단순군이다
