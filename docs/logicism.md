...
**정의(HP).** 개념에 대상을 대응시키는 연산 `#` 에 대해 다음이 성립한다는 것이 Hume 원리다.
...
[수학적 직관주의](mathematical-intuitionism.md)와 [형식주의와 Hilbert 프로그램](formalism-hilbert-program.md)까지 포함하면 20세기 초 기초론의 세 갈래가 완성된다. 셋 모두 역설의 충격에 대한 대응이었고, 셋 모두 원래 형태로는 성공하지 못했으며, 셋 모두 지금 수학의 일부로 남았다.
