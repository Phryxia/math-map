...
정수에서 $6=2\cdot 3$ 이 본질적으로 유일한 분해라는 사실은 나눗셈 정리에서 따라온다. 나눗셈 정리가 있으면 유클리드 알고리즘이 돌고, 최대공약수가 두 원소의 결합으로 쓰이며, 기약원이 소원이 되어 유일성이 나온다. 이 사슬의 각 칸을 조건으로 분리한 것이 아래 세 부류다.
