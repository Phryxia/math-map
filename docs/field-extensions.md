...
$\mathbb{Q}$ 의 유한 확대를 수체(number field)라 하고 정수론의 기본 대상이 된다. 대수적 수끼리의 합과 곱이 다시 대수적이라는 사실은 $\mathbb{Q}(\alpha,\beta)$ 가 유한 확대라는 탑 법칙 논증으로 얻어지며, 소멸 다항식을 직접 만드는 것보다 훨씬 간단하다.
