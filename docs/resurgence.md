...
alien 미분들은 자유 Lie 대수를 이루고 그 지수사상이 Stokes 자동사상들의 군을 준다. Écalle–Voronin 의 비선형 미분방정식 국소 해석적 분류에서 이 자료가 완전 불변량이다. 형식적 변환으로 표준형까지 갈 수 있지만 그 변환이 발산하고, 발산의 정도인 Stokes 자료가 해석적 동치류를 결정한다.[^1]
