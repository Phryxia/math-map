...
**Gan–Gross–Prasad 추측**은 한 [군의 표현](group-representations.md)이 아니라 군의 쌍을 본다. 크기가 하나 차이나는 고전군의 쌍 $G_{n+1}\supset G_n$ 에서 $G_{n+1}$ 의 표현을 $G_n$ 으로 제한했을 때 $G_n$ 의 주어진 표현이 나타나는 횟수, 곧 **분지 중복도**가 대상이다.
