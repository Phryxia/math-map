...
여덟 기하 중 일곱은 분류되어 있고, 남은 [쌍곡 3 다양체](hyperbolic-3-manifolds.md)에서는 Mostow 강직성으로 기하가 위상 불변량이 된다.
...
$\mathbb H^3$ 조각에는 유한한 매개변수 목록이 없고 Mostow 강직성으로 기하 자체가 불변량이다. 분류 문제가 유한 자료의 열거에서 Kleinian 군의 분류로 바뀐다.
