...
원리는 존재를 주장하지만 대상을 지목하지 않는다. 같은 달에 태어난 두 사람을 찾으려면 결국 조사해야 한다. 배타적 논리합에 의존하는 이 성격은 [직관주의 논리](intuitionistic-logic.md)에서 논쟁의 대상이 되는 전형적 형태다. 다만 유한형은 유한 탐색으로 증인을 찾을 수 있으므로 구성적으로도 받아들여진다.
