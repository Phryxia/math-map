...
- 쌍선형: $e(P_1+P_2,Q)=e(P_1,Q)e(P_2,Q)$, 둘째 변수도 마찬가지.
- 교대: $e(P,P)=1$, 따라서 $e(P,Q)=e(Q,P)^{-1}$.
- 비퇴화: $P\ne O$ 면 $e(P,Q)\ne1$ 인 $Q$ 가 존재한다.
- Galois 동변: $e(\sigma P,\sigma Q)=\sigma(e(P,Q))$.
...
$p=23$, $E:y^2=x^3+1$ 은 $p\equiv2\pmod3$ 이라 초특이 곡선이고 $\#E(\mathbb F_{23})=24$, 매장 차수가 2 다. $r=3$ 으로 잡고 Tate 쌍의 쌍선형성을 확인한다.
