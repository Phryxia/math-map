...
확장은 여럿이다. $B_{\mathrm{dR}}$ 수준의 Sen 작용소(Fontaine), $(\varphi,\Gamma)$ [가군](modules.md) 위에서의 Sen 작용소(Colmez, Kedlaya–Liu), 프리즘 관점(Bhatt–Lurie)이 모두 $\Gamma$ 작용을 미분해 얻은 작용소가 표현의 불변량을 담는다는 착상을 따른다.
