...
$V^\natural$ 은 중심전하 $24$ 의 등각장론이고 $\mathbb M$ 은 그 대칭군이다. Witten 은 이것을 $\mathrm{AdS}\_3$ 순수 양자 중력의 경계 이론 후보로 제안했다. 계수 $c(n)$ 이 BTZ 블랙홀의 상태 수를 센다는 해석이며, 이 제안이 종수 0 의 물리적 유도를 끌어낸 계기가 되었다.
