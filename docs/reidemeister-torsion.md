...
$L(7,1)$ 의 값 $0.7530,\thinspace 2.4450,\thinspace 3.8019$ 은 $4\sin^2(2\pi b/7)$ 을 $b=1,2,3$ 에서 계산한 값이다. 렌즈 공간의 RT(Reshetikhin–Turaev) 불변량을 Gauss 합 상호법칙으로 분해했을 때 각 평탄 접속의 진폭으로 나오는 수와 같다.
