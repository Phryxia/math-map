...
곱, 교집합, 당김, 몫, 붙임은 서로 다른 분야에서 따로 배우는 구성이지만 [범주](category.md)론에서는 하나의 문장의 사례다. 그 문장은 "어떤 도형에 맞춰지는 대상들 가운데 가장 보편적인 것" 이다. 이 대상이 극한(limit)이고, 화살표를 모두 뒤집은 쌍대 개념이 쌍대극한(colimit)이다.
...
극한은 종단대상이므로 두 극한 $L$ 과 $L'$ 사이에 원뿔을 보존하는 사상이 양방향으로 유일하게 존재하고, 그 합성은 유일성으로 항등사상이다. 따라서 $L \cong L'$ 이고, "그" 극한이라는 표현이 정당화된다.
