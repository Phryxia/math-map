...
Gauss 는 이 관계에 여덟 가지 증명을 남겼다. 오늘날의 설명은 두 소수가 하나의 더 큰 대상인 원분체의 Galois 군을 통해 서로를 본다는 것이다. 이 관점이 유체론으로 자라고, 아벨이 아닌 경우로 넓히려는 시도가 [Langlands 강령](langlands-program.md)이 되었다.
