...
$\aleph_1$ 과 $2^{\aleph_0}$ 사이에 놓이는 기수들 가운데 측도와 범주에서 자연스럽게 정의되는 것들이 있다. 이들 사이의 부등식 일부는 ZFC 에서 증명되고 나머지는 강제법으로 어느 쪽이든 만들 수 있다.
...
제1범주 집합에 대해 같은 두 물음을 던지면 값이 둘 더 생긴다. 이렇게 얻은 기수들 사이의 대소 관계를 정하는 것이 문제다.
